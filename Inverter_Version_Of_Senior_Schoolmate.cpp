...
#define Initial_Value_Of_CMPA    0
...
__interrupt void cpu_timer0_isr(void) {
   ...
   if(GpioDataRegs.GPADAT.bit.GPIO24 == 1){
	   ...
	   EPwm1Regs.CMPA.half.CMPA = 0;//CMPA1Value ;//Half_FREQ_TBPRD	;
	   EPwm2Regs.CMPA.half.CMPA = 0;//CMPA2Value ;//Half_FREQ_TBPRD	;
	   SysCtrlRegs.PCLKCR0.bit.TBCLKSYNC = 1;
	   EALLOW;
	   ...
	   EPwm2Regs.CMPA.half.CMPA = 0;	//Half_FREQ_TBPRD	;
	   EPwm1Regs.DBCTL.bit.OUT_MODE = 0x00;
	   EPwm2Regs.DBCTL.bit.OUT_MODE = 0x00;
	   //EPwm1Regs.AQCTLA.bit.CAU = AQ_CLEAR;
	   //EPwm1Regs.AQCTLA.bit.CAD = AQ_CLEAR;
