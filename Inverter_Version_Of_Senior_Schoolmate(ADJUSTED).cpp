...
GPIO0 - >  MOS2  	GPIO1 - > MOS1
GPIO2 - >  MOS4	    GPIO3 - > MOS3
*/
//###########################################################################
...
int VoValue[256] , IoValue[256] , ADCCount = 0 , TempVoValue = 0 , TempIoValue = 0 , CMPA1Value = FREQ_TBPRD, CMPA2Value = FREQ_TBPRD , IoCalVlue = 0;
...
__interrupt void cpu_timer0_isr(void) {
   ...
   if(GpioDataRegs.GPADAT.bit.GPIO24 == 1){
	   ...
	   EPwm1Regs.CMPA.half.CMPA = CMPA1Value ; //Half_FREQ_TBPRD	;
	   EPwm2Regs.CMPA.half.CMPA = CMPA2Value ; //Half_FREQ_TBPRD	;
	   SysCtrlRegs.PCLKCR0.bit.TBCLKSYNC = 1;
	   EALLOW;
	   ...
	   SysCtrlRegs.PCLKCR0.bit.TBCLKSYNC = 0;
	   EPwm1Regs.CMPA.half.CMPA = FREQ_TBPRD;
	   EPwm2Regs.CMPA.half.CMPA = FREQ_TBPRD;	//Half_FREQ_TBPRD	;
	   EPwm1Regs.DBCTL.bit.POLSEL = 0x00;
	   EPwm2Regs.DBCTL.bit.POLSEL = 0x00;
	   SysCtrlRegs.PCLKCR0.bit.TBCLKSYNC = 1;
	   EALLOW;
